        ...
        <ScrollView className="flex-1 px-4 py-10">
          <View className="relative bg-white shadow-lg">
            ...
            <View className="absolute flex-row inset-x-0 top-5 justify-between px-6">
              ...
              >
                <FontAwesome5 name="chevron-left" size={24} color="#229be8" />
              </TouchableOpacity>

              <TouchableOpacity className="w-10 h-10 rounded-md items-center justify-center bg-[#229be8]">
          ...
          <View className="mt-6">
          <Text className="text-[#229be8] text-[24px] font-bold">
            {data?.name}
          </Text>
...
<View className=" space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
          {data?.phone && (
            <View className="items-center flex-row space-x-6">
              <FontAwesome name="phone" size={18} color="#428288" />
              <Text className="text-lg">{data?.phone}</Text>
            </View>
          )}
          {data?.email && (
            <View className="items-center flex-row space-x-6">
              <FontAwesome name="envelope" size={18} color="#428288" />
              <Text className="text-lg">{data?.email}</Text>
            </View>
          )}
          {data?.address && (
            <View className="items-center flex-row space-x-6">
              <FontAwesome name="map-pin" size={18} color="#428288" />
